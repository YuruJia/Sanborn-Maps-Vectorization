...
print("Welcome to the Color Picking tool")
print("Please choose your area in the second image displayed by first left and then right clicking on it.")
print("Once you're satisfied with the chosen RGB values, you may close the picker by pressing ESC.")
...
# Citation of the following code snippet: Om Singh, Blog Electroica, URL: https://blog.electroica.com/eye-dropper-color-picker-tool-in-python-using-opencv/
# Last accessed on the: 15th Juni 2022
...
#transform picked color into a threshold using different tolerance values
