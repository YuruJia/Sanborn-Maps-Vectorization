...
class imgProcess(object):
    ...
    def process(self, input_tif_dir, input_shp_dir, output_dir, sizeX, sizeY, bufferX, bufferY):
        ...
        output_edge_dir = os.path.join(output_dir, "edge")
        self.file_check(output_edge_dir)
        count = 1
        ...
        for shp_file in os.listdir(input_shp_dir):
            ...
            for key, value in pic_cut_info.items():
                ...
                if len(geometries) > 0:
                    ...
                    self.draw_polygon(output_tif_dir, output_edge_dir, key, geometries)
...
if __name__ == '__main__':
    ...
    # imgProcess().process(input_tif_dir=r"D:\SanbornMap\data\test\sheets",
    #                      input_shp_dir=r"D:\SanbornMap\data\test\buildings",
    #                      output_dir=r"..\processed_data\test",
    #                      sizeX=256, sizeY=256, bufferX=128, bufferY=128)

    imgProcess().process(input_tif_dir=r"D:\SanbornMap\data\train\sheets",
                         input_shp_dir=r"D:\SanbornMap\data\train\buildings",
                         output_dir=r"D:\SanbornMap\UNet\data\train\train",
                         sizeX=256, sizeY=256, bufferX=128, bufferY=128)
