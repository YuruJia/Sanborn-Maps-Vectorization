...
def train():
    ...
    # (Initialize logging)
    if wandb_log:
        experiment = wandb.init(project='U-Net-Family', resume='allow', anonymous='must')
        experiment.config.update(dict(model_type=model_type, epochs=epochs, batch_size=batch_size, learning_rate=learning_rate,
    ...
    for epoch in range(epochs):
     ...
     # ===================================== Validation ====================================#
        ...
        if save_checkpoint:
            ...
            torch.save(unet.state_dict(), str(dir_ckp / '{}_batchsize_{}_epoch{}.pth'.format(model_type, batch_size,epoch + 1)))
