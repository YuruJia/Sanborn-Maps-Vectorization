...
class PictCut(object):
    ...
    def imageCutByRasterIO(self, inputFile, outputPath, bufferX, bufferY, sizeX, sizeY, count):
    ...
    def process(self, inputfile, outputpath, sizeX=1200, sizeY=1200, bufferX=200, bufferY=200, count=1):
        start_time = time()
...
if __name__ == '__main__':
    PictCut().process(inputfile=r"D:\ReToCarto\Project-SanbornMap\material_sanborn\sheets\6751.tif",
                      outputpath=r"D:\ReToCarto\output",
                      sizeX=512, sizeY=512, bufferX=0, bufferY=0, count=1)
